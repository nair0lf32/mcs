...
<img src="{{ site.baseurl }}/assets/posts-assets/avci-sylvien-superficiel.jpg?v={{ site.github.build_revision }}" alt="AVCI sylvien superficiel" />
...
<img src="{{ site.baseurl }}/assets/posts-assets/signes-indirects-ischemie.png?v={{ site.github.build_revision }}" alt="signes indirects ischemie" width=200/>

<img src="{{ site.baseurl }}/assets/posts-assets/signes-indirects-ischemie2.png?v={{ site.github.build_revision }}" alt="signes indirects ischemie2" width=200/>
...
<img src="{{ site.baseurl }}/assets/posts-assets/irm-avci.jpg?v={{ site.github.build_revision }}" alt="signes indirects ischemie" />
...
<img src="{{ site.baseurl }}/assets/posts-assets/hemorragie-capsulo-lenticulaire.jpg?v={{ site.github.build_revision }}" alt="hemorragie capsulo lenticulaire" />
